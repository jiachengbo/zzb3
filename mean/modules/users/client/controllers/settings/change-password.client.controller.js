(function () {
  ...
  ChangePasswordController.$inject = ['$scope', '$http', 'appService', 'UsersService', 'PasswordValidator', 'Notification'];

  function ChangePasswordController($scope, $http, appService, UsersService, PasswordValidator, Notification) {
    var vm = this;
