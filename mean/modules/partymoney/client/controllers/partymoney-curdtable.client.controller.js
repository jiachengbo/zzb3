(function () {
  ...
  angular
    .module('partymoney')
    .controller('PartymoneyCURDTableController', PartymoneyCURDTableController);

  PartymoneyCURDTableController.$inject = ['$scope', 'Notification', '$log', '$window',
    'uiGridConstants', 'PartymoneyService',
    '$uibModal'];
  function PartymoneyCURDTableController($scope, Notification, $log, $window,
